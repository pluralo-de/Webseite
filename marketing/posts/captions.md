...
## 01 · Wofür Pluralo steht

Kacheltyp A · Statement · Säule Haltung · 1 Bild · anpinnen

**Hinweis:** Nach dem Posten anpinnen. Das ist dauerhaft die erste Kachel im Profil.

Dateien:

- `post-01-1-wofuer-pluralo-steht.png`

Bildunterschrift:

```
Websites, die gefunden werden und überzeugen.
...
Kacheltyp C · Wissen · Säule Angebot · 3 Bilder

Dateien:

- `post-02-1-was-wir-machen.png`
- `post-02-2-was-wir-machen.png`
- `post-02-3-was-wir-machen.png`

Bildunterschrift:

```
Vier Bereiche, mit denen wir Unternehmen sichtbar machen.
...
## 03 · 5 Gründe, warum Ihre Website keine Anfragen bringt

Kacheltyp C · Wissen · Säule Wissen · 3 Bilder

Dateien:

- `post-03-1-keine-anfragen.png`
- `post-03-2-keine-anfragen.png`
- `post-03-3-keine-anfragen.png`

Bildunterschrift:

```
Fünf Gründe, warum eine Website keine Anfragen bringt.
...
```
Hinter Pluralo steht ein Mensch, kein Kundenportal.
...
## 06 · Das Google-Unternehmensprofil

Kacheltyp A + C · Säule Wissen · 3 Bilder

Dateien:

- `post-06-1-google-profil.png`
- `post-06-2-google-profil.png`
- `post-06-3-google-profil.png`

Bildunterschrift:

```
Ihr Google-Unternehmensprofil ist Ihre zweite Startseite.
...
- `post-07-1-so-arbeiten-wir.png`
- `post-07-2-so-arbeiten-wir.png`
- `post-07-3-so-arbeiten-wir.png`
...
```
Wir arbeiten von Andernach aus.
...
## 09 · Kostenloses Erstgespräch

Kacheltyp E · Luft · Säule Angebot · 2 Bilder · anpinnen

**Hinweis:** Nach dem Posten anpinnen. Damit steht der Kontaktweg dauerhaft oben im Profil.

Dateien:

- `post-09-1-erstgespraech.png`
- `post-09-2-erstgespraech.png`

Bildunterschrift:

```
Wie sichtbar ist Ihr Unternehmen heute?
